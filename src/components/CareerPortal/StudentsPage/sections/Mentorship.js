...
const Mentorship = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-white via-[#f7f7ff] to-white">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center relative">
            ...
            <div className="mt-6 bg-white p-6 rounded-xl shadow-lg w-full max-w-sm -translate-y-8 z-10">
