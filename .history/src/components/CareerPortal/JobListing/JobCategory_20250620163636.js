...
const JobSearch = ({ onSearch }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex space-x-2 max-w-md mx-auto" role="search">
      <input
        type="text"
...
const JobListings = ({ filters, searchQuery }) => {
  const jobs = [
    { id: 1, title: "AI Research Scientist", team: "Artificial Intelligence", location: "Menlo Park, CA", jobType: "Full-time", experience: "Senior Level", description: "Advance ML techniques in Meta research.", datePosted: "2023-05-15" },
    { id: 2, title: "Software Engineer Intern", team: "Software Engineering", location: "Seattle, WA", jobType: "Internship", experience: "Internship", description: "Work on real projects as a software intern.", datePosted: "2023-06-01" },
    { id: 3, title: "Data Scientist", team: "Data Science", location: "London, UK", jobType: "Full-time", experience: "Entry Level", description: "Analyze data for strategic decisions.", datePosted: "2023-05-28" },
  ];
  ...
  return (
    <div className="space-y-6">
      {filteredJobs.map((job) => (
        ...
        >
          <h3 id={`job-title-${job.id}`} className="text-xl font-semibold text-blue-700">
            {job.title}
          </h3>
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1 space-y-6">
            <section className="bg-white rounded-lg shadow p-6 max-w-full" aria-label="Job search">
              <JobSearch onSearch={setSearchQuery} />
            </section>

            <section className="bg-white rounded-lg shadow p-6" aria-live="polite" aria-atomic="true">
