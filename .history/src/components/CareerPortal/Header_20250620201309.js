          ...
          <ul>
            <li className="nav-item">
              <span className="nav-link" onClick={() => toggleDropdown("jobs")}>
                ...
                <i
                  className={`fa-solid ${
                    activeDropdown === "jobs" ? "fa-angle-up" : "fa-angle-down"
                  }`}
                ></i>
              </span>
            ...
            <li className="nav-item">
              ...
              <div className="dropdown locations-dropdown">
                <Link to="/jobs/location/dehradun">Dehradun</Link>
                <Link to="/jobs/location/haridwar">Haridwar</Link>
                <Link to="/jobs/location/nainital">Nainital</Link>
                <Link to="/jobs/location/mussorie">Mussorie</Link>
                <Link to="/jobs/location/roorkee">Roorkee</Link>
              </div>
            </li>
            ...
            <li className="nav-item">
              <span className="nav-link" onClick={() => toggleDropdown("life")}>
                ...
                <i
                  className={`fa-solid ${
                    activeDropdown === "life" ? "fa-angle-up" : "fa-angle-down"
                  }`}
                ></i>
              </span>
            ...
            <li className="nav-item">
              ...
              >
                ...
                <i
                  className={`fa-solid ${
                    activeDropdown === "about" ? "fa-angle-up" : "fa-angle-down"
                  }`}
                ></i>
              </span>
