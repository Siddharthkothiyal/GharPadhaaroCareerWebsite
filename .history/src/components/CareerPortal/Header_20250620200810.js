          ...
          <ul>
            ...
            <li className='nav-item'>
              ...
              <div className="dropdown locations-dropdown">
                ...
                <Link to="/locations/haridwar">Haridwar</Link>
                <Link to="/locations/nainital">Nainital</Link>
                <Link to="/locations/mussorie">Mussorie</Link>
                <Link to="/locations/roorkee">Roorkee</Link>
              </div>
            </li>
