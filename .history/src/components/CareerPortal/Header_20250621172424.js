          ...
          <ul>
            ...
            <li className="nav-item">
              ...
              <div className="dropdown students-menu">
                <Link smooth to="/students#internships">
                  Internship Opportunities
                </Link>
                <Link smooth to="/students#fresher-jobs">
                  Fresher Job Roles
                </Link>
                <Link smooth to="/students#early-careers">
                  Early Career Programs
                </Link>
                <Link smooth to="/students#hackathons">
                  Hackathons & Challenges
                </Link>
                <Link smooth to="/students#webinars">
                  Career Webinars
                </Link>
                <Link smooth to="/students#scholarships">
                  Scholarships
                </Link>
                <Link smooth to="/students#mentorship">
                  Mentorship Programs
                </Link>
                <Link smooth to="/students#resources">
                  Learning Resources
                </Link>
                <Link smooth to="/students#faqs">
                  FAQs for Students
                </Link>
              </div>
            </li>
