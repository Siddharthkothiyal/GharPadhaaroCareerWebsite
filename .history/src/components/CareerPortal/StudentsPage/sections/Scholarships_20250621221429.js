    ...
    <section className="py-12 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* Scholarship 1 */}
          <div className="bg-green-50 rounded-lg shadow-md p-6 hover:shadow-lg transition">
          ...
          {/* Scholarship 2 */}
          <div className="text-[#525599] rounded-lg shadow-md p-6 hover:shadow-lg transition">
            <h3 className="text-xl font-semibold text-[#525599] mb-2">
