...
const Resources = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-[#f3f4f8] to-[#eef0ff]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {/* Resource 1 */}
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-t-4 border-[#525599] p-6">
