...
const FreshersJob = () => {
  return (
    <section id="fresher-jobs" className="py-16 bg-gradient-to-br from-white via-gray-50 to-white">
          ...
          {freshersJobs.map((job) => (
            ...
            >
              ...
              <div className="text-sm text-gray-500 space-y-1 mb-4">
                ...
                <p><span className="font-medium text-gray-700">💰 Pay:</span> {job.pay}</p>
              </div>
