      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {freshersJobs.map((job) => (
            ...
            >
              <h3 className="text-xl font-semibold text-[#525599]">{job.title}</h3>
              ...
              <button className="mt-4 inline-block px-4 py-2 bg-[#525599] text-white text-sm rounded-lg hover:bg-blue-700 transition-colors">
                Apply Now
              </button>
            </div>
          ))}
