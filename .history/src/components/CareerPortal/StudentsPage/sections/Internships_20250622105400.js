...
const Internships = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[-5rem] left-[-5rem] w-96 h-96 bg-purple-100 opacity-20 rounded-full -z-10 blur-3xl" />
      <div className="absolute bottom-[-5rem] right-[-5rem] w-96 h-96 bg-indigo-100 opacity-20 rounded-full -z-10 blur-3xl" />

      <div className="max-w-7xl mx-auto">
        {/* Section Heading */}
        <h2 className="text-4xl sm:text-5xl font-extrabold text-center text-[#2f315d] mb-6 tracking-tight">
          Internships & Career Growth at GharPadharo
        </h2>
        <p className="text-center text-gray-600 text-lg max-w-3xl mx-auto mb-16 leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-28">
          <div className="lg:w-1/2 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-base text-gray-700">
              ...
              <div className="flex items-start gap-2">
                <span className="h-2.5 w-2.5 mt-2 bg-[#525599] rounded-full" />
                <span>Remote working flexibility</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="h-2.5 w-2.5 mt-2 bg-[#525599] rounded-full" />
          ...
          <div className="lg:w-1/2">
            <img
              ...
              alt="Internship Path"
              className="rounded-2xl shadow-xl w-full max-w-lg mx-auto transition-transform duration-300 hover:scale-[1.03]"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16 mb-28">
          <div className="lg:w-1/2 text-left">
            ...
            <ul className="text-base text-gray-700 space-y-3 pl-5 list-disc">
              <li>Intern – Foundation through hands-on learning</li>
              <li>Junior Associate – Work in real teams</li>
              <li>Associate – Handle core features independently</li>
              <li>Team Lead – Mentor and manage initiatives</li>
              <li>Expert/Specialist – Innovate, lead, inspire</li>
            </ul>
          </div>
        ...
        <div className="text-center mt-10">
          ...
          <button
            ...
            className="inline-block px-10 py-3 bg-[#525599] text-white text-lg font-medium rounded-full shadow-md hover:bg-[#41447d] transition-all duration-300"
          >
